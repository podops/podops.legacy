...
func (s *Show) Validate(v *Validator) *Validator {
	...
	v.AssertContains(s.Metadata.Labels, LabelLanguage, LabelLanguage)
	v.AssertContains(s.Metadata.Labels, LabelExplicit, LabelExplicit)
	v.AssertContains(s.Metadata.Labels, LabelType, LabelType)
	v.AssertContains(s.Metadata.Labels, LabelBlock, LabelBlock)
	v.AssertContains(s.Metadata.Labels, LabelComplete, LabelComplete)
	v.AssertContains(s.Metadata.Labels, LabelGUID, LabelGUID)
...
func (e *Episode) Validate(v *Validator) *Validator {
	...
	v.AssertContains(e.Metadata.Labels, LabelGUID, LabelGUID)
	v.AssertContains(e.Metadata.Labels, LabelParentGUID, LabelParentGUID)
	v.AssertContains(e.Metadata.Labels, LabelDate, LabelDate)
	v.AssertContains(e.Metadata.Labels, LabelSeason, LabelSeason)
	v.AssertContains(e.Metadata.Labels, LabelEpisode, LabelEpisode)
	v.AssertContains(e.Metadata.Labels, LabelExplicit, LabelExplicit)
	v.AssertContains(e.Metadata.Labels, LabelType, LabelType)
	v.AssertContains(e.Metadata.Labels, LabelBlock, LabelBlock)
